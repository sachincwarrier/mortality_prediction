...
CREATE EXTERNAL TABLE `mp_bg`(
  `hadm_id` int COMMENT '', 
  `charttime` timestamp COMMENT '', 
  `specimen` string COMMENT '', 
  `aado2` double COMMENT '', 
  `baseexcess` double COMMENT '', 
  `bicarbonate` double COMMENT '', 
  `totalco2` double COMMENT '', 
  `carboxyhemoglobin` double COMMENT '', 
  `chloride` double COMMENT '', 
  `calcium` double COMMENT '', 
  `glucose` double COMMENT '', 
  `hematocrit` double COMMENT '', 
  `hemoglobin` double COMMENT '', 
  `intubated` string COMMENT '', 
  `lactate` double COMMENT '', 
  `methemoglobin` double COMMENT '', 
  `o2flow` double COMMENT '', 
  `fio2` double COMMENT '', 
  `so2` double COMMENT '', 
  `pco2` double COMMENT '', 
  `peep` double COMMENT '', 
  `ph` double COMMENT '', 
  `po2` double COMMENT '', 
  `potassium` double COMMENT '', 
  `requiredo2` double COMMENT '', 
  `sodium` double COMMENT '', 
  `temperature` double COMMENT '', 
  `tidalvolume` double COMMENT '', 
  `ventilationrate` double COMMENT '', 
  `ventilator` double COMMENT '')
ROW FORMAT SERDE 
...
LOCATION
  's3://aws-athena-query-results-791229000584-us-east-1/Unsaved/2019/12/08/tables/390d3341-9590-4633-8754-b0daaeb926ca'
TBLPROPERTIES (
  'has_encrypted_data'='false', 
  'transient_lastDdlTime'='1575827925')